...
:::warning Tombstoning is permanent, once tombstoned a validator's consensus key can not be reused within the chain where the tombstoning happened. :::
...
* and, the (re)delegator is attempting to create a _new_ redelegation where the source validator for this new redelegation is `Validator X`.
