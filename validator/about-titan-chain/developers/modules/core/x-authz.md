...
* [Concepts](broken-reference)
  * [Authorization and Grant](broken-reference)
  * [Built-in Authorizations](broken-reference)
  * [Gas](broken-reference)
* [State](broken-reference)
  * [Grant](broken-reference)
  * [GrantQueue](broken-reference)
* [Messages](broken-reference)
  * [MsgGrant](broken-reference)
  * [MsgRevoke](broken-reference)
  * [MsgExec](broken-reference)
* [Events](broken-reference)
* [Client](broken-reference)
  * [CLI](broken-reference)
  * [gRPC](broken-reference)
  * [REST](broken-reference)
...
* The `send` authorization\_type refers to the built-in `SendAuthorization` type. The custom flags available are `spend-limit` (required) and `allow-list` (optional) , documented [here](broken-reference)
...
* The `generic` authorization\_type refers to the built-in `GenericAuthorization` type. The custom flag available is `msg-type` ( required) documented [here](broken-reference).
...
* The `delegate`,`unbond`,`redelegate` authorization\_types refer to the built-in `StakeAuthorization` type. The custom flags available are `spend-limit` (optional), `allowed-validators` (optional) and `deny-validators` (optional) documented [here](broken-reference).
